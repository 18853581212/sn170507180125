package cn.classroom.android.sdwu.edu.sn170507180125;
...
public class demo1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView imageView=(ImageView) findViewById(R.id.demo1_iv);
        ...
        imageView.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                ...
                try{
                    ...
                    Log.e(demo1.class.toString(),e.toString());
                }
    ...
    class MyClickListener implements View.OnClickListener{
        ...
        public void onClick(View view) {
            Log.i(demo1.class.toString(),"button click");
        }
    }
